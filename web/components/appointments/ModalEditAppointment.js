...
export default function ModalEditAppointment() {
  const [open, setOpen] = useRecoilState(stateModalAppointment);
    ...
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={() => setOpen(false)}>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 dark:bg-neutral-900 dark:bg-opacity-90 bg-gray-500 bg-opacity-75 transition-opacity" />
        </Transition.Child>
